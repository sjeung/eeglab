...
function  [IDX,C,sumd,D,outliers] = robust_kmeans(data,N,STD,MAXiter,method,replicates)
...
if strcmpi(method, 'kmeans')
    [IDX,C,sumd,D] = kmeans(data,N,'replicates',replicates,'emptyaction','drop'); % Cluster using K-means algorithm
else
